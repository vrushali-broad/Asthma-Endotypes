...
# Severe -->
fname = 'Mild.pdf'
df = pd.read_csv("../Output/sim_1_tmp_0.txt",sep ='\t')
df = df.T
...
data_sub = data[['Eosinophils','Neutrophils','Th2', 'Th17', 'Th1', 'Treg', 'Stimulant_I', 'Stimulant_II', 'Stimulant_III']]
legend_labels = ['Eosinophils','Neutrophils','T$_\mathrm{H}$2', 'T$_\mathrm{H}$17', 'T$_\mathrm{H}$1', 'T$-$reg',
				'Stimulant T$_\mathrm{H}$2', 'Stimulant T$_\mathrm{H}$17', 'Stimulant T$_\mathrm{H}$1',]
